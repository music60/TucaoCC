 ...
 * @TODO
 */
public class TucaoMediaPlayerControl extends MediaController {
    ...
    public TucaoMediaPlayerControl(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = this;
        mFromXml = true;
    ...
    public TucaoMediaPlayerControl(Context context) {
        super(context);
...
//       mDuration = duration;
    ...
    private OnClickListener mPauseListener = new OnClickListener() {
        public void onClick(View v) {
            doPauseResume();
            UI.toast(getContext(),"mPauseListener");
            show(sDefaultTimeout);
        }
    };
